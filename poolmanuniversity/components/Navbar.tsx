...
const Navbar = () => {
  return (
    <nav className="w-full flex items-center justify-between container mx-auto mt-6 bg-white/90 px-4 py-4 backdrop-blur-md dark:bg-gray-900/90 shadow-md rounded-full">
      <div>
