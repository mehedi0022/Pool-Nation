...
const MembershipTiers = () => {
  return (
    <div className="px-5">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 md:mt-20 mb-6">
        ...
        <div>
          ...
          <p className="mb-4">
            Whether you’re building your foundation or ready to scale, Pool
            Nation has a membership designed to help you grow, profit, and
            thrive.
          </p>
          ...
          <ul className="ml-4 mb-4">
            <li className="flex gap-0.5 justify-start items-center">
              <CheckCheck size={20} /> Proven business systems that drive
              results
            </li>
            <li className="flex gap-0.5 justify-start items-center">
              <CheckCheck size={20} />
